...
@optional
- (NSMutableURLRequest * _Nullable)requestForSocketID:(NSString * _Nonnull)socketID channel:(PusherChannel * _Nonnull)channel SWIFT_WARN_UNUSED_RESULT;
...
@protocol Authorizer
- (void)fetchAuthValueWithSocketID:(NSString * _Nonnull)socketID channelName:(NSString * _Nonnull)channelName completionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(PusherAuth * _Nullable))completionHandler;
@end
...
@property (nonatomic, readonly, copy) NSString * _Nonnull auth;
@property (nonatomic, readonly, copy) NSString * _Nullable channelData;
- (nonnull instancetype)initWithAuth:(NSString * _Nonnull)auth channelData:(NSString * _Nullable)channelData OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
///
- (void)websocketDidReceiveMessageWithSocket:(WebSocket * _Nonnull)ws text:(NSString * _Nonnull)text;
...
///
- (void)websocketDidDisconnectWithSocket:(WebSocket * _Nonnull)ws error:(NSError * _Nullable)error;
/// Delegate method called when a websocket connected
/// \param ws The websocket that connected
///
- (void)websocketDidConnectWithSocket:(WebSocket * _Nonnull)ws;
- (void)websocketDidReceiveDataWithSocket:(WebSocket * _Nonnull)ws data:(NSData * _Nonnull)data;
@end
